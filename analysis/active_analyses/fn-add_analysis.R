...
add_analysis <- function(
  ...
  cut_points_list <- list(
    ...
    unvax_sub_covidhospital_TRUE = "1;28;365;1460"
  )
  ...
  if (
    ...
    cut_points <- cut_points_list$unvax_sub_covidhospital_TRUE
  }

  if (
    cohort == "unvax" &&
      outcome == "out_date_ild" &&
      grepl("^sub_covidhospital_TRUE_preex_TRUE", analysis_name)
  ) {
    cut_points <- cut_points_list$unvax_sub_covidhospital_TRUE
  }
