...
When running, you should first check if [`active_analyses.rds`](lib/active_analyses.rds) exists (and is up to date)
  ...
  - Then, run [`active_analyses.R`](./analysis/active_analyses/active_analyses.R) locally to create/update [`active_analyses.rds`](lib/active_analyses.rds)
...
Detailed information about the outcomes can be found in the [`project-specific protocol`](protocol/post-covid-events-respiratory.pdf).
...
A concatenation of the flow descriptors generated by [`fn-inex.R`](./analysis/dataset_clean/fn-inex.R) and [`fn-qa.R`](./analysis/dataset_clean/fn-qa.R), the inclusion/exclusion function and the quality assurance function.
